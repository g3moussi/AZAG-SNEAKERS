      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <button
            ...
            className="md:hidden p-2 text-[#3D3028] hover:text-[#2C2118] focus:outline-hidden"
          ...
          <div className="flex-1 md:flex-initial text-center md:text-left">
            <button
              ...
              className="group focus:outline-hidden py-1"
            >
          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            <button
              ...
              className="p-2 text-[#3D3028] hover:text-[#2C2118] hover:bg-[#F4EFEB] rounded-full transition-colors relative"
            ...
            >
              ...
              {wishlistCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-rose-600 text-white text-[11px] font-bold w-4 h-4 rounded-full flex items-center justify-center animate-pulse">
                  {wishlistCount}
                </span>
              )}
            </button>
            ...
            <button
              onClick={onOpenCart}
              className="flex items-center gap-2 bg-[#2C2118] text-white px-4 py-2 rounded-full hover:bg-[#3D3028] transition-all shadow-xs hover:shadow-md group"
              aria-label="Voir le panier"
            >
              <ShoppingBag className="w-4 h-4 text-[#D4A373] group-hover:scale-110 transition-transform" />
              <span className="text-xs font-semibold tracking-wider uppercase">Panier</span>
              <span className="bg-[#D4A373] text-[#2C2118] text-xs font-extrabold px-2 py-0.5 rounded-full ml-1">
                {cartCount}
              </span>
            </button>
          </div>
