        ...
        {orderComplete ? (
          ...
          <div className="p-8 sm:p-12 text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href={`https://wa.me/212752424260?text=${encodeURIComponent(`Bonjour AZAG, je viens de passer la commande N° ${orderId} pour un montant de ${total} DH. Nom: ${fullName}, Ville: ${city}, Tél: ${phone}`)}`}
                target="_blank"
                rel="noreferrer"
